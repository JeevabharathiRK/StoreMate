...
//                 <div className="h-25 min-w-55 mt-5 rounded-md bg-[#ffffff] shadow-md">
//                     <div id="details" className="flex flex-col m-5 gap-2">
//                         <div className="font-bold text-[#556484]">
//                             Total Sales
//                         </div>
...
//             <div className="text-[#111827] text-2xl font-semibold mb-6">
//                 Dashboard
//             </div>

//             {/* Top Summary Cards */}
//             <div className="grid grid-cols-3 gap-6">
//                 <Card title="Total Sales" value="₹00,000" />
//                 <Card title="Total Orders" value="00" />
//                 <Card title="Revenue This Month" value="₹00,000" />
//             </div>

//             {/* Mid Section - Inventory + Graph */}
//             <div className="grid grid-cols-2 gap-6 mt-6">
//                 {/* Inventory Overview */}
//                 <div className="bg-white rounded-md shadow-md p-5">
//                     <div className="font-semibold text-[#111827] mb-2">Inventory Overview</div>
//                     <div className="text-3xl font-bold text-[#111827] mb-4">000</div>
...
//                     <div className="h-32 w-full bg-gray-100 rounded-md flex items-center justify-center text-sm text-gray-400">
//                         [Graph Placeholder]
//                     </div>
//                 </div>
//             </div>

//             {/* Bottom Section - Transactions & Top Selling */}
//             {/* <div className="grid grid-cols-2 gap-6 mt-6">
//                 <div className="bg-white rounded-md shadow-md p-5">
//                     <div className="font-semibold text-[#111827] mb-2">Recent Transactions</div>
//                     <div className="h-24 bg-gray-100 rounded-md"></div>
//                 </div>

//                 <div className="bg-white rounded-md shadow-md p-5">
//                     <div className="font-semibold text-[#111827] mb-2">Top Selling Products</div>
//                     <div className="h-24 bg-gray-100 rounded-md"></div>
//                 </div>
//             </div> */}
...
//                 <div className="font-semibold text-[#111827] mb-2">Search Product by Barcode Number</div>
...
//                     />
//                     <button className="bg-[#1F2937] text-white px-6 py-2 rounded-md">
//                         Search
//                     </button>
//                 </div>
//             </div>
...
//     // TODO: Send update to backend API here
//   }
...
//     }
//     try {
//       // Replace with your backend API call to get product info by barcode
